...
# Integration Test 9
# Testing IR Transmitter with Joystick
...
joystick_center_x = 500
joystick_center_y = 500
...
def main():
   ...
   while True:
       ...
       encoded_x = int(((16*(current_x+4)))/1000)
       encoded_y = int(((16*(current_y-16)))/1000)
       transmitter.transmit(encoded_x,encoded_y)
       print("encoded values: ", encoded_x," ",encoded_y)
        # Turn off all LEDs
       ...
       time.sleep(0.3)  # Delay to prevent overwhelming the output
